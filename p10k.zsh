# Generated by Powerlevel10k configuration wizard on 2023-02-23 at 21:50 CET.
...
() {
  ...
  # Default highlight directory color.
  #typeset -g POWERLEVEL9K_PATH_HIGHLIGHT_FOREGROUND=39
  # Display highlight directory segment in bold.
  #typeset -g POWERLEVEL9K_PATH_HIGHLIGHT_BOLD=true
